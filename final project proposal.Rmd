...
We are going to draw a histogram to find out the most popular color (if the dog has more than one color, it will be categorized as “mix”) of dogs in  Allegheny County. According to zipcodes, a heatmap can be used to visualize where people prefer to get their dogs lifetime lienced.

Our major challenge is the large size of datasets, we need to find some reasonable criterias to filter the valid data. Also, for the dog breed, we need to create a new category under color called “mixed” to replace the multiple combinations of different colors. 
